...
jogadores = {
    "Nome": [
        "Marcos", "Cafu", "Luísão", "Edmilson", "Juninho Paulista", "Rivaldo", "Ronaldo", "Ronaldinho Gaúcho", "Kléber", "Dida",
    ...
    "Clube": [
        "Palmeiras", "Roma", "Corinthians", "São Paulo", "Flamengo", "Barcelona", "Real Madrid", "Paris Saint-Germain", "Stuttgart", "Milan",
